...
func (s *SpacesSuite) TestAddTwoSpaceWithDifferentNamesButSameProviderIdSucceedsInDifferentModels(c *gc.C) {
	args1 := addSpaceArgs{
		Name:       "my-space",
		ProviderId: network.Id("provider id"),
		ForState:   s.State,
...
func (s *SpacesSuite) TestAddTwoSpaceWithDifferentNamesAndEmptyProviderIdSucceedsInSameModel(c *gc.C) {
	args1 := addSpaceArgs{
		Name:       "my-space",
		ProviderId: "",
	}
...
func (s *SpacesSuite) TestAddTwoSpaceWithDifferentNamesAndEmptyProviderIdSucceedsInDifferentModels(c *gc.C) {
	args1 := addSpaceArgs{
		Name:       "my-space",
		ProviderId: "",
		ForState:   s.State,
...
func (s *SpacesSuite) TestAddTwoSpaceWithSameNamesAndProviderIdsFailsInTheSameModel(c *gc.C) {
	args := addSpaceArgs{
		Name:       "my-space",
...
func (s *SpacesSuite) TestAddTwoSpaceWithSameNamesAndEmptyProviderIdsSuccedsInDifferentModels(c *gc.C) {
	args1 := addSpaceArgs{
		Name:       "my-space",
		ProviderId: "",
		ForState:   s.State,
...
func (s *SpacesSuite) TestAddTwoSpaceWithSameNamesAndProviderIdsSuccedsInDifferentModels(c *gc.C) {
	args1 := addSpaceArgs{
		Name:       "my-space",
...
func (s *SpacesSuite) TestAddSpaceWhenSubnetsDoNotExist(c *gc.C) {
	name := "my-space"
