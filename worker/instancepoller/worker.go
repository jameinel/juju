...
func (u *updaterWorker) loop() (err error) {
	...
	// change to the tracker; which should then be used with the firewaller
	// and provisioner workers that still use WaitForEnviron, allowing us to
	// maintain a single shared environ that updates in the background \o/.
