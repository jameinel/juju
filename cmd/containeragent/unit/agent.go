...
func (c *containerUnitAgent) workers() (worker.Worker, error) {
	...
	if err := addons.StartIntrospection(addons.IntrospectionConfig{
        ...
        // TODO: jam 2022-06-10 it feels bad passing nil for fsm lease
	if err := addons.RegisterEngineMetrics(c.prometheusRegistry, metrics, eng, workerMetricsSink, nil); err != nil {
